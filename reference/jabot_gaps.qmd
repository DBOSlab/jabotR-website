...
- Missing taxa broken down by **kingdom**, **family**, **genus**, and
...
| ffb_path | Character or `NULL`. Path to a directory holding a previously downloaded FFB DwC-A dataset (created by [floraR::flora_download()]). When `NULL` (default) the dataset is downloaded automatically. |
...
| dir | Character. Output directory. Defaults to `"herbarium_gap_analysis"`. |
