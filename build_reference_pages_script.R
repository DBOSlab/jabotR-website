...
# --- Configuration ----------------------------------------------------------
pkg_name <- "jabotR"                                   # package name
pkg_dir  <- "/Users/domingoscardoso/Library/Mobile Documents/com~apple~CloudDocs/Publications_Bioinformatics/jabotR_package_and_website/jabotR"
